      ...
      <DialogContent className="sm:max-w-xl max-h-[90vh] overflow-y-auto">
        <form onSubmit={handleSubmit(onSubmit)}>
          <DialogHeader>
            ...
            <DialogDescription>
              {mode === "create"
                ? "Set up a new meeting type for scheduling."
          ...
          <div className="flex flex-col gap-5 py-5">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {defaultValues?.color && (
                      <div
                        ...
                        style={{ backgroundColor: defaultValues.color }}
                      />
                    )}
                  </div>
                  {errors.color && (
            ...
            {/* Section 3: Buffer & Limits */}
            <div className="flex flex-col gap-3">
              <SectionHeading>Buffer &amp; Limits</SectionHeading>
              <FieldGroup>
                <div className="flex flex-col gap-1.5">
...
export function CreateEventTypeButton({ teams }: { teams?: TeamOption[] }) {
  return (
    <EventTypeForm mode="create" teams={teams}>
      <Button variant="brand">Create event type</Button>
    </EventTypeForm>
  )
}
